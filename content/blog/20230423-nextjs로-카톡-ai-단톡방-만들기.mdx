...
tags:
  ...
  - fullStack
category: dev
summary: Next.js와 ChatGPT API로 AI 단톡방 구현 - indexedDB 활용과 다자간 채팅 로직
thumbnail: ''
published: true
---

![웹뷰](/blog/images/20230423-nextjs로-카톡-ai-단톡방-만들기.png)
...
![npmtrends](/blog/images/20230423-nextjs로-카톡-ai-단톡방-만들기-01.png)
tailwindcss도 생각보다 많이 사용하고 있음에 놀랐다.

### 4. next.js

이번 프로젝트 기반 기술이긴 했지만, next.js는 react기반 풀스택 프레임워크이다.
서버 사이드 렌더링을 기본적으로 지원하기 때문에 html document자체를 서버에서 렌더링하여 클라이언트에 노출되기 때문에 기본적으로 SEO에 좋다.
...
이번에 처음으로 **indexedDB**를 사용해 보았다. indexedDB는 cookie, localstorage와 비슷한 웹 스토리지 종류중 하나이며, cookie와 localstorage 보다 훨씬 더 많은 용량을 저장할 수 있고, 문자열 이외의 자료형들도 저장이 가능한 장점이 있다.
...
![indexedDB활용](/blog/images/20230423-nextjs로-카톡-ai-단톡방-만들기-02.png)
정말 귀엽고 작은 db 이다.
